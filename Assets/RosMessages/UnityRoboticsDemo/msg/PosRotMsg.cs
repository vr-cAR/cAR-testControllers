...
namespace RosMessageTypes.UnityRoboticsDemo
{
    ...
    public class PosRotMsg : Message
    {
        ...
        public PosRotMsg(float pos_x, float pos_y, float pos_z, float rot_x, float rot_y, float rot_z, float rot_w, float velocity, float curvature)
        {
            this.pos_x = pos_x;
            this.pos_y = pos_y;
            this.pos_z = pos_z;
        ...
        private PosRotMsg(MessageDeserializer deserializer)
        {
            ...
            */
            ...
            deserializer.Read(out this.curvature);
        }
        ...
        public override void SerializeTo(MessageSerializer serializer)
        {
            ...
            */
            ...
            serializer.Write(this.curvature);
        }
